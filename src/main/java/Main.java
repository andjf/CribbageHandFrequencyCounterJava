...
public class Main {
	 ...
	 * More info about scoring here
	 * https://www.mastersofgames.com/rules/cribbage-rules.htm
	 * 
	 * @param hand The hand to score
	...
	public static void main(String[] args) {
		if (args.length == 1) {
			// If there is a single command line argument, attempt to compare to the given
			// file
